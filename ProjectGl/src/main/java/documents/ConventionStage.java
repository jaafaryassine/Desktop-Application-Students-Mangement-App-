...
public class ConventionStage extends Doc {
	...
	public void generateDoc() throws MalformedURLException, FileNotFoundException {
		...
		table.addCell(
				new Cell().add("CONVENTION DE STAGE  ").setBold().setFontSize(20F).setPaddingLeft(50).setBorder(gb));
		document.add(table);
		document.add(new Paragraph("\n \n ENTRE \n \n").setPaddingLeft(230));

		document.add(new Paragraph(
				" L'Ecole Nationale des Sciences Appliquées, Université Abdelmalek Essaâdi - Tétouan B.P. 2222, Mhannech II, Tétouan , Maroc \n"
		...
		document.add(new Paragraph("L'ENTREPRISE accepte de recevoir à titre de stagiaire " + nom + " étudiant(e) "
				...
				+ "Université Abdelmalek Essaâdi (Tétouan), pour une période allant du " + date_debut_stage + "au"
				+ date_fin_stage).setFontSize(10F));

		document.add(
				new Paragraph("En aucun cas, cette convention ne pourra autoriser les étudiants à s'absenter durant"
		...
		document.add(new Paragraph(
				"Le stage aura pour objet essentiel d'assurer l'application pratique de l'enseignement donné par l'Etablissement, et ce, "
						+ "en organisant des visites sur les installations et en réalisant des études proposées par L'ENTREPRISE.")
				.setFontSize(10F));

		document.add(new Paragraph("Article 3 : Encadrement et suivi").setBold().setFontSize(10F));
		document.add(new Paragraph(
				"Pour accompagner le Stagiaire durant son stage, et ainsi instaurer une véritable collaboration L'ENTREPRISE/Stagiaire/Etablissement,"
						...
						+ "L'Etablissement désigne.........................en tant que tuteur qui procurera une assistance pédagogique")
				.setFontSize(10F));

		document.add(new Paragraph("Article 4 : Programme:").setBold().setFontSize(10F));
		document.add(
				new Paragraph("Le thème du stage est :................................................................ "
		...
		document.add(new Paragraph(
				"Au cours du stage, l'étudiant ne pourra prétendre à aucun salaire de la part de L'ENTREPRISE. \n"
						...
						+ " une indemnité forfaitaire de la part de l'ENTREPRISE des frais occasionnés par la mission confiée à l'étudiant.")
				.setFontSize(10F));
		document.add(new Paragraph("Article 6 : Règlement").setBold().setFontSize(10F));
		document.add(new Paragraph(
				"Pendant la durée du stage, le Stagiaire reste placé sous la responsabilité de l'Etablissement. \n" + ""
		...
		document.add(new Paragraph("Le Stagiaire et l'ensemble des acteurs liés à son travail "
				...
				+ "stage.\n").setFontSize(10F));
		document.add(
				new Paragraph("Article 8 : Assurance accident de travail Le stagiaire ").setBold().setFontSize(10F));
		document.add(new Paragraph(
				"stagiaire devra obligatoirement souscrire une assurance couvrant la Responsabilité Civile et Accident de"
		...
		table3.addCell(new Cell().add("Nom et signature du Stagiaire").setBorder(Border.NO_BORDER).setFontSize(10F)
				.setPaddingLeft(20));
		...
		table4.addCell(new Cell().add(" \r \n Signature et cachet de l.'Etablissement").setBorder(Border.NO_BORDER)
				.setFontSize(10F).setPaddingLeft(20));
		table4.addCell(new Cell().add(" \r\nSignature et cachet de L'ENTREPRISE").setBorder(Border.NO_BORDER)
				.setFontSize(10F).setPaddingLeft(20));
		document.add(table4);
